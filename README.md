...
1. **systemd 254 or newer, with cgroup v2**. Required for launching and managing session processes. `systemd-run`, `sh`, `cat`, `true`, and `Xwayland` must be available on Moonshine's `PATH`.
